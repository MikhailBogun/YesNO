...
let directive = {
    ...
    template:"<div class='fig' ng-repeat='posts in main.promise | filter:searchText'> <h2>{{posts.massage+posts.Name}}</h2>" +
      ...
      "<div><button type=\"button\" class=\"btn btn-success\" ng-click=\"main.getReaction(1,posts)\"  >Yes</button>"+"<button type=\"button\" class=\"btn btn-danger\" ng-click=\"main.getReaction(0,posts)\" >No</button></div>"+
